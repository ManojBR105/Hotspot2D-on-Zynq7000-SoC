...
HD_PWD='C:/Users/mba151/Documents/proj_files/ip_repo/edit_counter64_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log counter64_v1_0.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source counter64_v1_0.tcl -notrace
